...
var ASM_CONSTS = {
  ...
  7726274: () => window.innerWidth,
  7726304: () => window.innerHeight
};

// Imports from the Wasm binary.
var _initHandTracking = Module["_initHandTracking"] = makeInvalidEarlyAccess("_initHandTracking");

var _setSimulatorPointer = Module["_setSimulatorPointer"] = makeInvalidEarlyAccess("_setSimulatorPointer");

var _updateHandPosition = Module["_updateHandPosition"] = makeInvalidEarlyAccess("_updateHandPosition");
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports["initHandTracking"] != "undefined", "missing Wasm export: initHandTracking");
  assert(typeof wasmExports["setSimulatorPointer"] != "undefined", "missing Wasm export: setSimulatorPointer");
  assert(typeof wasmExports["updateHandPosition"] != "undefined", "missing Wasm export: updateHandPosition");
  ...
  _initHandTracking = Module["_initHandTracking"] = createExportWrapper("initHandTracking", 2);
  _setSimulatorPointer = Module["_setSimulatorPointer"] = createExportWrapper("setSimulatorPointer", 1);
  _updateHandPosition = Module["_updateHandPosition"] = createExportWrapper("updateHandPosition", 3);
  ...
  dynCall_iiiif = dynCalls["iiiif"] = createExportWrapper("dynCall_iiiif", 5);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createKataraModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createKataraModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createKataraModule);
